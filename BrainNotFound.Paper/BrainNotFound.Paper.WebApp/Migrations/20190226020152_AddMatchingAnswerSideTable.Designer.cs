...
namespace BrainNotFound.Paper.WebApp.Migrations
{
    ...
    [Migration("20190226020152_AddMatchingAnswerSideTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrainNotFound.Paper.WebApp.Models.BusinessModels.MatchingAnswerSide", b =>
                {
            ...
            modelBuilder.Entity("BrainNotFound.Paper.WebApp.Models.BusinessModels.StudentEssayAnswer", b =>
                {
                    b.HasBaseType("BrainNotFound.Paper.WebApp.Models.BusinessModels.StudentAnswer");

                    b.Property<string>("EssayAnswerGiven");

                    b.ToTable("StudentEssayAnswer");

                    b.HasDiscriminator().HasValue("StudentEssayAnswer");
                });

            modelBuilder.Entity("BrainNotFound.Paper.WebApp.Models.BusinessModels.StudentTrueFalseAnswer", b =>
                {
                    b.HasBaseType("BrainNotFound.Paper.WebApp.Models.BusinessModels.StudentAnswer");

                    b.Property<bool>("TrueFalseAnswerGiven");

                    b.ToTable("StudentTrueFalseAnswer");
            ...
            modelBuilder.Entity("BrainNotFound.Paper.WebApp.Models.BusinessModels.StudentMatchingAnswer", b =>
                {
                    ...
                    b.HasOne("BrainNotFound.Paper.WebApp.Models.BusinessModels.MatchingAnswerSide", "MatchingAnswerSide")
                        .WithMany("StudentMatchingAnswers")
